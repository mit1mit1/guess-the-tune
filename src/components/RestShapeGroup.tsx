...
const RestShapePath = ({ baseDuration, baseXPosition, color, opacity, handleClick }: RestShapePathProps) => {
    switch (baseDuration) {
        case "16n":
            return <EigthOrSixteenthRest color={color} opacity={opacity} handleClick={handleClick} xCentre={getRootCircleCX(baseXPosition)} isSixteenth={true} />
        case "8n":
        case "8n.":
            return <EigthOrSixteenthRest color={color} opacity={opacity} handleClick={handleClick} xCentre={getRootCircleCX(baseXPosition)} />
        case "4n":
        case "4n.":
            return <QuarterRest color={color} opacity={opacity} handleClick={handleClick} xCentre={getRootCircleCX(baseXPosition)} />
        case "2n":
        case "2n.":
        case "1n":
        case "1n.":
...
const QuarterRest = ({ handleClick, color, opacity, xCentre }: QuarterRestProps) => {
    return (
        <>
            <line
                strokeWidth={8}
                stroke={color}
                opacity={opacity}
                x1={xCentre - quarterRestLength / 2} y1={getBaseYPosition("E5")} x2={xCentre + quarterRestLength / 2} y2={getBaseYPosition("C5")}
            ...
            <line
                ...
                stroke={color}
                opacity={opacity}
                x1={xCentre + quarterRestLength / 2} y1={getBaseYPosition("C5")} x2={xCentre - quarterRestLength / 2} y2={getBaseYPosition("B4")}
                className={handleClick ? 'clickable-svg' : ''}
                onClick={handleClick}
            />
            <line
                ...
                stroke={color}
                opacity={opacity}
                x1={xCentre - quarterRestLength / 2} y1={getBaseYPosition("B4")} x2={xCentre + quarterRestLength / 2} y2={getBaseYPosition("G4")}
                className={handleClick ? 'clickable-svg' : ''}
                onClick={handleClick}
            />
            ...
            <path
                ...
                stroke={color}
                fill="none"
                opacity={opacity} className={handleClick ? 'clickable-svg' : ''}
                onClick={handleClick}
                d={`M ${xCentre + quarterRestLength / 2} ${getBaseYPosition("G4")} A ${quarterRestLength / 2} ${quarterRestLength / 4} 10 0 0 ${xCentre} ${getBaseYPosition("F4")}`} />
        </>
    )
}
...
const EigthOrSixteenthRest = ({ handleClick, color, opacity, xCentre, isSixteenth }: EigthOrSixteenthRestProps) => {
    ...
    const sixteenthYDisplacement = - (lineXTop - lineXBottom) * sixteenthProportionDown * lineGradient;
    const sixteenthXDisplacement = - (lineXTop - lineXBottom) * sixteenthProportionDown;
    return (
        <>
            <line
                strokeWidth={5}
                stroke={color}
                opacity={opacity}
                x1={lineXBottom} y1={lineYBottom} x2={lineXTop} y2={lineYTop}
                className={handleClick ? 'clickable-svg' : ''}
                onClick={handleClick}
            />
            <path
                ...
                opacity={opacity} className={handleClick ? 'clickable-svg' : ''}
                onClick={handleClick}
                d={`M ${lineXTop} ${lineYTop} A ${eigthRestLength / 2} ${eigthRestLength / 8} -30 0 1 ${lineXTop - eigthRestLength} ${lineYTop + eigthRestLength / 2}`} />
            <circle
            ...
            {isSixteenth && <>
                <path
                    ...
                    opacity={opacity} className={handleClick ? 'clickable-svg' : ''}
                    onClick={handleClick}
                    d={`M ${lineXTop + sixteenthXDisplacement} ${lineYTop + sixteenthYDisplacement} A ${eigthRestLength / 2} ${eigthRestLength / 8} -30 0 1 ${lineXTop - eigthRestLength + sixteenthXDisplacement} ${lineYTop + eigthRestLength / 2 + sixteenthYDisplacement}`} />
                <circle
